...
?>
	...
	<div id="content" class="site-content">
		<div class="container">
			...
			<?php bosa_medical_health_blog_advertisement_banner(); ?>
							...
							<?php
								if( !get_theme_mod( 'disable_pagination', false ) ):
									the_posts_pagination( array(
										...
										'next_text' => '<span>'.esc_html__( 'Next', 'bosa-medical-health' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Next page', 'bosa-medical-health' ) . '</span>',
										'prev_text' => '<span>'.esc_html__( 'Prev', 'bosa-medical-health' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Previous page', 'bosa-medical-health' ) . '</span>',
										'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'bosa-medical-health' ) . ' </span>',
									));
								endif;
								wp_reset_postdata();
							?>
